...
if __name__ == "__main__":
    im_l = array(Image.open('./images/cones/im2.png').convert('L'), 'f')
    im_r = array(Image.open('./images/cones/im6.png').convert('L'), 'f')
    ...
    # ncc 的宽度
    wid = 12
    save_file_name = 'depth_wid' + str(wid) + '.png'
    res = plane_sweep_ncc(im_l, im_r, start, steps, wid)

    imsave(save_file_name, res)
